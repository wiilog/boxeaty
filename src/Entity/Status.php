...
class Status {
    ...
    public const CODE_ORDER_PREPARED = "ORDER_PREPARED";
    public const CODE_ORDER_AWAITING_DELIVERER = "ORDER_AWAITING_DELIVERER";
    ...
    public const CODE_PREPARATION_TO_PREPARE = "PREPARATION_TO_PREPARE";
    ...
    public const CODE_DELIVERY_PREPARED = "DELIVERY_PREPARED";
